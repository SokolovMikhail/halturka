...
$this->params['header_links'] = [
	...
	[
		...
		'link'	=> '/admin/main-devices/create-warranty/?orderId='.$backId,
	],
	[
		'icon'	=> 'fa fa-files-o ',
		'title'	=> 'Добавить копированием',
		'link'	=> '/admin/main-devices/create-warranty/?orderId='.$backId.'&deviceId='.$adminModel->id,
	]	
];
?>
					...
					<div class="row mb-10" data-ajax-form-harness-row>
						...
						<div class="col-md-2">
							<div class="form-group mb-0">
								<input class="form-control mb-0" type="number" name="BrandsConfig[counts][]" value="<?= $equipItem['count']?>" <?= $configModel->owner_type == 'configuration' ? 'disabled' : ''?>>
							</div>
						</div>										
